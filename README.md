# <img alt=":O Bread" src="https://bread-api-images.russiandev.repl.co/images/icon.png" style="display:block;width:2.5%;margin-left:auto;margin-right:auto;"> Bread-API
